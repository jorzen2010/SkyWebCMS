        ...
        function rdochecked(tag) {
            $('.' + tag).each(function (i) {
                ...
                if ($('.' + tag).eq(i).prop("checked") == false) {
                    ...
                    rdobox.find(".check-image").css("background", "url(/assets/images/input-unchecked.png)");
                }
                else {
                    rdobox.removeClass("unchecked");
                    rdobox.addClass("checked");
                    rdobox.find(".check-image").css("background", "url(/assets/images/input-checked.png)");
                }
            });
        }
    }
